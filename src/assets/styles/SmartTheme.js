...
const SmartTheme = {
  ...
  components: {
    ...
    button: {
      ...
      colorScheme: {
        light: {
          ...
          outlined: {
            primary: {
              hoverBackground: 'color-mix(in srgb, {primary.color}, transparent 90%)',
              activeBackground: 'color-mix(in srgb, {primary.color}, transparent 80%)',
              borderColor: '{primary.color}',
              color: '{primary.color}',
            },
            secondary: {
              hoverBackground: 'color-mix(in srgb, {secondary.color}, transparent 90%)',
              activeBackground: 'color-mix(in srgb, {secondary.color}, transparent 80%)',
    ...
    skeleton: {
      ...
      colorScheme: {
        light: {
          root: { background: '{surface.200}', animationBackground: 'rgba(255,255,255,0.4)' },
        },
        dark: {
          root: {
    ...
    toggleswitch: {
      ...
      handle: { borderRadius: '50%', size: '1.5rem' },
      colorScheme: {
        light: {
          root: {
